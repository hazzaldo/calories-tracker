# Calories Tracker
Calories Tracker allows you to track the calories' intakes of different users. You can:

- Create a new username - to add a new user.
...
Ensure to run `npm install` to install all required packages:
```
npm install
```
